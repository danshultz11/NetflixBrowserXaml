...
namespace WikipediaQueryToolXaml
{
    public sealed partial class SplitPage
    {
        ...
        private Netflix.Catalog.v2.Title _context;
        public Netflix.Catalog.v2.Title Context
        {
            get
            {
        ...
        private List<Netflix.Catalog.v2.Title> _items;
        public List<Netflix.Catalog.v2.Title> Items
        {
            get
            {
                return this._items;
